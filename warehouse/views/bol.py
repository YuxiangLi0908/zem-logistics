...
class BOL(View):
    ...
    def handle_select_get(self, request: HttpRequest) -> dict[str, Any]:
        ...
        context["shipment_list"] = context["shipment_list"].filter(
        ...
        packling_list = (
            ...
            .order_by("container_number__container_number", "-total_weight_lbs")
        )
    ...
    def handle_search_post(self, request: HttpRequest) -> dict[str, Any]:
        ...
        if container_number:
            criteria &= models.Q(
                packinglist__container_number__container_number=container_number
        ...
        warehouse_object = (
            ZemWarehouse.objects.get(name=warehouse) if warehouse else None
        )
