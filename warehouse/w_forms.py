...
# # from .w_models import Customer, Container, PackingList, ZemWarehouse, Shipment
...
# class DestinationSelectFrom(forms.Form):
#     def __init__(self, *args, **kwargs) -> None:
#         super(DestinationSelectFrom, self).__init__(*args, **kwargs)
#         valid_destinations = Shipment.objects.values_list("destination", flat=True).distinct()
#         choices = [("", "")]
#         choices += [(d, d) for d in valid_destinations]
#         self.fields["destination"] = forms.CharField(widget=forms.Select(choices=choices))


# class PackingListShipForm(forms.ModelForm):
#     class Meta:
#         model = PackingList
#         fields = [
#             "id", "container_number", "shipping_mark", "fba_id", "ref_id", 
