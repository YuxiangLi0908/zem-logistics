...
class Offload(models.Model):
    ...
    public_total_pallet = models.IntegerField(null=True, blank=True, verbose_name="la公仓拆柜板子总数")
    other_total_pallet = models.IntegerField(null=True, blank=True, verbose_name="la私仓拆柜板子总数")
