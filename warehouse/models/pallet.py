...
class Pallet(models.Model):
    ...
    company = models.CharField(max_length=2000, null=True, blank=True, verbose_name="Company")
    road = models.CharField(max_length=2000, null=True, blank=True, verbose_name="Road")
    ...
    ltl_unit_quote = models.FloatField(null=True, blank=True, verbose_name="ltl的单板报价")
