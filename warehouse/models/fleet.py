...
class Fleet(models.Model):
    ...
    departured_at = models.DateTimeField(null=True, blank=True, verbose_name="国内方的出库时间")
    shipped_at = models.DateTimeField(null=True, blank=True, verbose_name="仓库方的出库时间")
