...
WAREHOUSE_OPTIONS = [
    ...
    ("SAV-31419", "SAV-31419"),
    ("SAV-31322", "SAV-31322"),
    ("SAV-31322-OLW", "SAV-31322-OLW"),
    ("SAV-31322-ALLWAYS", "SAV-31322-ALLWAYS"),
    ("LA-91761", "LA-91761"),
    ("LA-91789", "LA-91789"),
    ("LA-91730", "LA-91730"),
    ("N/A(直送)", "N/A(直送)"),
...
MODEL_CHOICES = {
    ...
    "invoicestatus": {
        ...
        "search_process": "container_number__container_number",
        "has_foreignKey": True,
        "warehouse": "warehouse_invoicestatus",
        "station_field": [],
    ...
    "invoicev2": {
        ...
        "search_process": "container_number__container_number",
        "has_foreignKey": True,
        "warehouse": "warehouse_invoicev2",
        "station_field": ["invoice_number"],
        "mapping": INVOICE_TABLE_MAPPING,
        "transfer_table": None,
    },
    "invoicestatusv2": {
        ...
        "search_process": "container_number__container_number",
        "has_foreignKey": True,
        "warehouse": "warehouse_invoicestatusv2",
        "station_field": ["invoice_number"],
        "mapping": INVOICESTATUS_TABLE_MAPPING,
        "transfer_table": None,
    },
    "invoiceitemv2": {
        "model": "HistoricalInvoiceItemv2",
        "name": "账单明细",
        "search_field": "container_number",
        "search_process": "container_number__container_number",
        "has_foreignKey": True,
        "warehouse": "warehouse_invoiceitemv2",
        "station_field": ["invoice_number"],
        "mapping": INVOICE_ITEM_TABLE_MAPPING,
        "transfer_table": None,
    },
    "dropshipcargo": {
        "model": "HistoricalDropshipCargo",
        "name": "一件代发货物",
        "search_field": "container_number",
        "search_process": "container__container_number",
        "has_foreignKey": True,
        "warehouse": None,
        "station_field": ["shipping_mark", "model"],
        "mapping": {},
        "transfer_table": None,
    },
    "dropshipinventory": {
        "model": "HistoricalDropshipInventory",
        "name": "一件代发库存流水",
        "search_field": "container_number",
        "search_process": "cargo__container__container_number",
        "has_foreignKey": True,
        "warehouse": None,
        "station_field": ["transaction_type", "operator"],
        "mapping": {},
        "transfer_table": None,
    },
    "dropshipshipmentdetail": {
        "model": "HistoricalDropshipShipmentDetail",
        "name": "一件代发出库明细",
        "search_field": "container_number",
        "search_process": "cargo__container__container_number",
        "has_foreignKey": True,
    ...
    "dropshipshipment": {
        "model": "HistoricalDropshipShipment",
        "name": "一件代发出库批次",
        "search_field": "shipment_batch_number",
        "search_process": "details__cargo__container__container_number",
        "has_foreignKey": True,
        "warehouse": None,
